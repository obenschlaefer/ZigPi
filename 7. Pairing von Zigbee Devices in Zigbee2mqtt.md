...
Mit dem Klick auf den Gerätenamen, kommt gelangt man in Eigenschfaten des Gerätes. <img width="118" alt="image" src="https://github.com/obenschlaefer/ZigPi/assets/79227566/02639588-2e42-4073-bb08-775f86134ecc"> Hier kann man u.a. den Gerätenamen ändern. Am besten ist es, hier eine kurzen und eindutigen Namen zu verwenden. 


Mit allen weiteren Geräten wird genauso verfahren. 

**Hinweis:**
Es kann durchaus vorkommen, dass das ordnungsgemäße Pairing einzelner Geräte fehlschlägt, aber sie dennoch in der Übericht auftauchen. In diesem Fall sollte man das entsprechende Gerät löschen, <img width="116" alt="image" src="https://github.com/obenschlaefer/ZigPi/assets/79227566/0a32b599-429b-4064-9b35-c218e863ab8f"> und das Pairing erneut starten. <img width="442" alt="image" src="https://github.com/obenschlaefer/ZigPi/assets/79227566/84916271-9218-44c6-b396-ea312963acf8">. Sollte sich das Gerät nicht löschen lassen, kann die Option ```löschen erzwingen``` aktiviert werden.
